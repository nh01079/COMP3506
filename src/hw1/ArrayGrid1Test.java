...
public class ArrayGrid1Test {
     ...
     */
    private void setup() {
        grid = new ArrayGrid1<>(WIDTH, HEIGHT);
    ...
    public void testCombo() {
        int width = 1;
        int height = 1;
        Grid<Integer> grid2 = new ArrayGrid1<>(width, height);
    ...
    public void testDimensions() {
        try {
            grid = new ArrayGrid1<>(0, 1);
            fail();
        } catch (IllegalArgumentException ex) {}

        try {
            grid = new ArrayGrid1<>(1, 0);
            fail();
        } catch (IllegalArgumentException ex) {}
    }
